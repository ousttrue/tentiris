...
register_feature(language_server, lsp_types.TEXT_DOCUMENT_DID_CLOSE, features.did_close)
register_feature(language_server, lsp_types.TEXT_DOCUMENT_DID_OPEN, features.did_open)
register_feature(
    language_server,
